...
public class PpseProviderMasterCard2Test implements IProvider {
	...
	public byte[] transceive(final byte[] pCommand) {
		...
		case 2:
			...
			break;
		case 3:
			response = "70 6B 9F 6C 02 00 01 9F 62 06 00 00 00 00 0E 00 9F 63 06 00 00 00 00 00 7E 56 2A 42 35 32 30 30 30 30 30 30 30 30 30 30 30 30 30 30 5E 20 2F 5E 30 32 30 37 32 30 32 30 30 30 30 30 31 30 30 30 30 30 30 30 30 9F 64 01 03 9F 65 02 00 0E 9F 66 02 0E 70 9F 6B 13 52 00 00 00 00 00 00 00 D0 11 92 02 00 00 01 00 00 00 0F 9F 67 01 03 90 00";
			break;
		case 4:
