...
public final class EMVTags {
	...
	public static final ITag AUTHORISATION_RESPONSE_CODE = new TagImpl("8a", TagValueTypeEnum.TEXT, "Authorisation Response Code",
	...
	public static final ITag ISSUER_AUTHENTICATION_DATA = new TagImpl("91", TagValueTypeEnum.BINARY, "Issuer Authentication Data",
			"Data sent to the ICC for online issuer authentication");
	public static final ITag ISSUER_PUBLIC_KEY_REMAINDER = new TagImpl("92", TagValueTypeEnum.BINARY, "Issuer Public Key Remainder",
			"Remaining digits of the Issuer Public Key Modulus");
	public static final ITag SIGNED_STATIC_APP_DATA = new TagImpl("93", TagValueTypeEnum.BINARY, "Signed Static Application Data",
			"Digital signature on critical application parameters for SDA");
	public static final ITag APPLICATION_FILE_LOCATOR = new TagImpl("94", TagValueTypeEnum.BINARY, "Application File Locator (AFL)",
	...
	public static final ITag TC_HASH_VALUE = new TagImpl("98", TagValueTypeEnum.BINARY, "Transaction Certificate (TC) Hash Value",
	...
	public static final ITag TRANSACTION_CURRENCY_EXP = new TagImpl("5f36", TagValueTypeEnum.NUMERIC, "Transaction Currency Exponent",
	...
	public static final ITag AMOUNT_AUTHORISED_NUMERIC = new TagImpl("9f02", TagValueTypeEnum.NUMERIC, "Amount, Authorised (Numeric)",
			"Authorised amount of the transaction (excluding adjustments)");
	...
	public static final ITag AMOUNT_OTHER_BINARY = new TagImpl("9f04", TagValueTypeEnum.NUMERIC, "Amount, Other (Binary)",
			"Secondary amount associated with the transaction representing a cashback amount");
	public static final ITag APP_DISCRETIONARY_DATA = new TagImpl("9f05", TagValueTypeEnum.BINARY, "Application Discretionary Data",
			"Issuer or payment system specified data relating to the application");
	public static final ITag AID_TERMINAL = new TagImpl("9f06", TagValueTypeEnum.BINARY, "Application Identifier (AID) - terminal",
			"Identifies the application as described in ISO/IEC 7816-5");
	...
	public static final ITag ISSUER_ACTION_CODE_DENIAL = new TagImpl("9f0e", TagValueTypeEnum.BINARY, "Issuer Action Code - Denial",
			"Specifies the issuerâ€™s conditions that cause the denial of a transaction without attempt to go online");
	public static final ITag ISSUER_ACTION_CODE_ONLINE = new TagImpl("9f0f", TagValueTypeEnum.BINARY, "Issuer Action Code - Online",
	...
	public static final ITag CRYPTOGRAM_INFORMATION_DATA = new TagImpl("9f27", TagValueTypeEnum.BINARY, "Cryptogram Information Data",
	...
	public static final ITag AMOUNT_REFERENCE_CURRENCY = new TagImpl("9f3a", TagValueTypeEnum.BINARY, "Amount, Reference Currency",
	...
	public static final ITag APPLICATION_CURRENCY_CODE = new TagImpl("9f42", TagValueTypeEnum.NUMERIC, "Application Currency Code",
	...
	public static final ITag APP_CURRENCY_EXPONENT = new TagImpl("9f44", TagValueTypeEnum.NUMERIC, "Application Currency Exponent",
	...
	public static final ITag DDOL = new TagImpl("9f49", TagValueTypeEnum.DOL, "Dynamic Data Authentication Data Object List (DDOL)",
	...
	public static final ITag MERCHANT_NAME_AND_LOCATION = new TagImpl("9f4e", TagValueTypeEnum.TEXT, "Merchant Name and Location",
